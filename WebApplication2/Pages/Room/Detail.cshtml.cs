...
namespace WebApplication2.Pages.Room
{
    public class DetailModel : PageModel
    {
        ...
        {
            new Feedback { Rating = 5, Comment = "Khách sạn rất tuyệt, tôi sẽ quay lại!" },
            new Feedback { Rating = 4, Comment = "Phòng ốc sạch sẽ, nhân viên phục vụ tận tình." },
            new Feedback { Rating = 3, Comment = "Khách sạn ổn nhưng dịch vụ ăn uống chưa được tốt lắm." }
        };
        }
